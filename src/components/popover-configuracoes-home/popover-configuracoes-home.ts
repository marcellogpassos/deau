  ...
  template: 
    `<div class="popover">
      <ion-list>
        ...
        <button ion-item *ngIf="mostraApenasFavoritos" (click)="apenasFavoritos()">Apenas favoritos</button>
      </ion-list>
    <div>`,
...
export class PopoverConfiguracoesHomeComponent {
  ...
  constructor(public viewCtrl: ViewController, public navParams: NavParams) {
    ...
    this.mostraApenasFavoritos = true;
  }
  ...
  apenasFavoritos() {
    this.sair(PopoverConfiguracoesHomeComponent.APENAS_FAVORITOS);
  }
